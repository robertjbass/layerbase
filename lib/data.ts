...
export const projects = [
  {
    name: "Efficient App",
    description: "Flagship developer tooling platform providing productivity solutions for modern development teams",
  ...
  {
    name: "DebtOS",
    description: "SaaS platform for accounts receivable automation. Winner of 2020 Pioneer startup program",
  ...
  },
  {
    ...
    description: "User-friendly PGP encryption application with local SQLite database for secure key management",
  ...
  {
    name: "Ask Chat",
    description: "Terminal-based ChatGPT client designed for quick questions without interrupting development workflow",
  ...
  {
    name: "NodePM UI",
    description: "Terminal process manager for Node.js applications with intuitive interface",
  ...
  },
  {
    ...
    description: "Framework-agnostic state management library inspired by Vuex patterns",
